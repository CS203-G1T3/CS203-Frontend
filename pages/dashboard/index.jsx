        ...
        <div className="h-screen flex">
            ...
            <div className="p-4 w-full">
                ...
                <div className="grid grid-flow-col lg:grid-cols-3 lg:grid-rows-2 gap-4 md:grid-cols-2 md:grid-rows-3">
                    ...
                    <PopUps header="Contact Tracing" value="100% required SAFE ENTRY" title="100% required SAFE ENTRY" body=" F&B establishments must implement SafeEntry via TraceTogether-only SafeEntry (TT-only SE) for dine-in customers and visitors"/>
